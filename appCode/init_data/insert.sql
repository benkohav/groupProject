...
INSERT INTO Category (CategoryName, CategoryDescription, Brand)
VALUES ('Laptop1', 'description2', 'what brand33333');
INSERT INTO Category (CategoryName, CategoryDescription, Brand)
VALUES ('Laptop2', 'description3', 'what brand444444');
INSERT INTO Category (CategoryName, CategoryDescription, Brand)
...
-- VALUES (6000, 'ItemName1' ,'ItemDescription1', 'Condition1', 110 , -1, '10.00' , '1234', '5678');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (7000, 'ItemName2' ,'ItemDescription2', 'Condition2', 80 , -2, '12.00' ,'4321', '3421');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (8000, 'ItemName3' ,'ItemDescription3', 'Condition3', 90 , -3, '13.00' ,'1111', '2222');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (9000, 'ItemName4' ,'ItemDescription4', 'Condition4', 100 , -4, '16.00' ,'3434', '4545');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (10000, 'ItemName5' ,'ItemDescription5', 'Condition5', 90 , -5, '15.00' ,'7777', '1212');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (11000, 'ItemName6' ,'ItemDescription6', 'Condition6', 110 , -6, '9.00' , '1234', '5678');
-- INSERT INTO Item (ItemId, ItemName, ItemDescription, Condition, CategoryID, userID, rentPerDay, timeBorrowed, timeReturned)
-- VALUES (12000, 'ItemName7' ,'ItemDescription7', 'Condition7', 120 , -7, '2.00' ,'4321', '3421');
...
INSERT INTO Image (ImageID, URL, CategoryID)
VALUES ('1900', 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fwww.howtogeek.com%2Fwp-content%2Fuploads%2F2016%2F07%2Fis-static-electricity-damage-still-a-huge-problem-with-electronics-now-00.jpg%3Fheight%3D200p%26trim%3D2%2C2%2C2%2C2&imgrefurl=https%3A%2F%2Fwww.howtogeek.com%2F262313%2Fis-static-electricity-damage-still-a-huge-problem-with-electronics%2F&tbnid=dFPopLqtM8kUkM&vet=12ahUKEwiq_KCdhqP7AhWDomoFHYIBDusQMygKegUIARDBAg..i&docid=n5zhNWTRUKVL3M&w=1292&h=592&q=static%20for%20eletronics&ved=2ahUKEwiq_KCdhqP7AhWDomoFHYIBDusQMygKegUIARDBAg', 7);
INSERT INTO Image (ImageID, URL, CategoryID)
VALUES ('2000', 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fm.media-amazon.com%2Fimages%2FI%2F41dw1g4jtnS.jpg&imgrefurl=https%3A%2F%2Fwww.amazon.com%2FFire-HD-10-tablet%2Fdp%2FB08BX7FV5L&tbnid=nJSbQIB6fvz4UM&vet=12ahUKEwioiYGxhqP7AhUXlWoFHSG1DwEQ94IIKAZ6BQgBEK8D..i&docid=O50p3Mt606ILmM&w=500&h=500&q=tablet&ved=2ahUKEwioiYGxhqP7AhUXlWoFHSG1DwEQ94IIKAZ6BQgBEK8D', 8);
INSERT INTO Image (ImageID, URL, CategoryID)
VALUES ('2100', 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fm.media-amazon.com%2Fimages%2FI%2F31OJZyIDWML._AC_.jpg&imgrefurl=https%3A%2F%2Fwww.amazon.com%2FMoKo-Tablet-Foldable-Multi-Angle-Holder%2Fdp%2FB017TU5KMQ&tbnid=rRJTbEdI4NFY5M&vet=12ahUKEwjv38LahqP7AhWrnWoFHdQ9CLIQMygOegUIARCGAw..i&docid=8QvOSHHhkErf6M&w=494&h=308&q=phone%20tablet&ved=2ahUKEwjv38LahqP7AhWrnWoFHdQ9CLIQMygOegUIARCGAw', 9);
